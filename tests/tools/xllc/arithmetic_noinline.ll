...
define i32 @add(i32 %0, i32 %1) noinline {
2:
  %3 = add i32 %0, %1
  ret i32 %3
}

define i32 @sub(i32 %0, i32 %1) noinline {
2:
  %3 = sub i32 %0, %1
  ret i32 %3
}

define i32 @mul(i32 %0, i32 %1) noinline {
2:
  %3 = mul i32 %0, %1
  ret i32 %3
}

define i32 @sdiv(i32 %0, i32 %1) noinline {
2:
  %3 = sdiv i32 %0, %1
  ret i32 %3
}

define i32 @srem(i32 %0, i32 %1) noinline {
2:
  %3 = srem i32 %0, %1
  ret i32 %3
}

define i32 @udiv(i32 %0, i32 %1) noinline {
2:
  %3 = udiv i32 %0, %1
  ret i32 %3
}

define i32 @urem(i32 %0, i32 %1) noinline {
2:
  %3 = urem i32 %0, %1
  ret i32 %3
}

define i32 @and(i32 %0, i32 %1) noinline {
2:
  %3 = and i32 %0, %1
  ret i32 %3
}

define i32 @or(i32 %0, i32 %1) noinline {
2:
  %3 = or i32 %0, %1
  ret i32 %3
}

define i32 @xor(i32 %0, i32 %1) noinline {
2:
  %3 = xor i32 %0, %1
  ret i32 %3
}

define i32 @shl(i32 %0, i32 %1) noinline {
2:
  %3 = shl i32 %0, %1
  ret i32 %3
}

define i32 @lshr(i32 %0, i32 %1) noinline {
2:
  %3 = lshr i32 %0, %1
  ret i32 %3
}

define i32 @ashr(i32 %0, i32 %1) noinline {
2:
  %3 = ashr i32 %0, %1
  ret i32 %3
}

define double @fadd(double %0, double %1) noinline {
2:
  %3 = fadd double %0, %1
  ret double %3
}

define double @fsub(double %0, double %1) noinline {
2:
  %3 = fsub double %0, %1
  ret double %3
}

define double @fmul(double %0, double %1) noinline {
2:
  %3 = fmul double %0, %1
  ret double %3
}

define double @fdiv(double %0, double %1) noinline {
2:
  %3 = fdiv double %0, %1
  ret double %3
}

define double @fneg(double %0) noinline {
1:
  %2 = fneg double %0
  ret double %2
}
