...
define i1 @icmp_eq(i32 %0, i32 %1) noinline {
2:
  %3 = icmp eq i32 %0, %1
  ret i1 %3
}

define i1 @icmp_ne(i32 %0, i32 %1) noinline {
2:
  %3 = icmp ne i32 %0, %1
  ret i1 %3
}

define i1 @icmp_slt(i32 %0, i32 %1) noinline {
2:
  %3 = icmp slt i32 %0, %1
  ret i1 %3
}

define i1 @icmp_sgt(i32 %0, i32 %1) noinline {
2:
  %3 = icmp sgt i32 %0, %1
  ret i1 %3
}

define i1 @icmp_sle(i32 %0, i32 %1) noinline {
2:
  %3 = icmp sle i32 %0, %1
  ret i1 %3
}

define i1 @icmp_sge(i32 %0, i32 %1) noinline {
2:
  %3 = icmp sge i32 %0, %1
  ret i1 %3
}

define i1 @icmp_ult(i32 %0, i32 %1) noinline {
2:
  %3 = icmp ult i32 %0, %1
  ret i1 %3
}

define i1 @icmp_ugt(i32 %0, i32 %1) noinline {
2:
  %3 = icmp ugt i32 %0, %1
  ret i1 %3
}

define i1 @icmp_ule(i32 %0, i32 %1) noinline {
2:
  %3 = icmp ule i32 %0, %1
  ret i1 %3
}

define i1 @icmp_uge(i32 %0, i32 %1) noinline {
2:
  %3 = icmp uge i32 %0, %1
  ret i1 %3
}

define i1 @fcmp_oeq(double %0, double %1) noinline {
2:
  %3 = fcmp oeq double %0, %1
  ret i1 %3
}

define i1 @fcmp_one(double %0, double %1) noinline {
2:
  %3 = fcmp one double %0, %1
  ret i1 %3
}

define i1 @fcmp_olt(double %0, double %1) noinline {
2:
  %3 = fcmp olt double %0, %1
  ret i1 %3
}

define i1 @fcmp_ogt(double %0, double %1) noinline {
2:
  %3 = fcmp ogt double %0, %1
  ret i1 %3
}

define i1 @fcmp_ole(double %0, double %1) noinline {
2:
  %3 = fcmp ole double %0, %1
  ret i1 %3
}

define i1 @fcmp_oge(double %0, double %1) noinline {
2:
